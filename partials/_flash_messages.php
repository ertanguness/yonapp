...
?>
        ...
        <div class="alert <?= $alertClass ?> bg-white text-start font-weight-600 mb-4" role="alert">
            <div class="d-flex align-items-center">
                <div>
                    <img src="assets/images/icons/<?= htmlspecialchars($msg['icon']) ?>" alt="ikon" style="width: 36px; height: 36px;">
                </div>
                <div style="margin-left: 10px;">
                    <h4 class="alert-title"><?= htmlspecialchars($msg['title']) ?></h4>
                    <div class="text-secondary"><?= htmlspecialchars($msg['message']) ?></div>
                </div>
            </div>
        </div>
<?php
