...
$router->get('borclarim', fn() => require 'pages/site-sakini/home.php');
...
$router->get('borc-odeme', fn() => require 'pages/dues/payment/list-new.php');
$router->get('borc-odeme/{id}', fn($id) => require 'pages/dues/payment/list-new.php');
...
|  ŞİKAYET & ÖNERİ
---------------------------------------------------- */
$router->get('sikayet-oneri-listesi', fn() => require 'pages/duyuru-talep/admin/sikayet-oneri-list.php');
$router->get('admin/sikayet-oneri-listesi', fn() => require 'pages/duyuru-talep/admin/sikayet-oneri-list.php');
$router->get('admin/sikayet-oneri-manage', fn() => require 'pages/duyuru-talep/admin/sikayet-oneri-manage.php');
...
$router->get('superadmin-kullanici-ekle',   fn() => require 'pages/panel/kullanicilar/manage.php');
...
$router->get('sakin/anketler/{id}', fn($id) => require 'pages/site-sakini/anketler.php');
