                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="fw-bold mb-0 me-4">
                                ...
                                <span class="fs-12 fw-normal text-muted text-truncate-1-line">Aşağıdaki Siteye ait
                                    bilgileri doldurarak kayıt ediniz!</span>
                            </h5>
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-outline-secondary route-link me-2"
                                    data-page="sites/list">
                                ...
                                <div class="col-lg-12">
                                    <div class="card border-top-0">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="sitebilgileriTab"
                                                role="tabpanel">
                                                <div class="card-body personal-info">
                                                    <div class="row mb-4 align-items-center">
                                                        <div class="col-lg-2">
                                                            <label for="fullnameInput" class="fw-semibold">Site Adı:
                                                            </label>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="input-group">
                                                                <div class="input-group-text"><i
                                                                        class="feather-home"></i></div>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <label for="fullnameInput" class="fw-semibold">Blok Sayısı:
                                                            </label>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="input-group">
                                                                <div class="input-group-text"><i
                                                                        class="feather-trello"></i></div>
                                                                <input type="text" class="form-control"
                                                                    id="fullnameInput" placeholder="Name">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        <div class="col-lg-2">
                                                            <label for="addressInput_1" class="fw-semibold">Adres:
                                                            </label>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control" id="addressInput_1"
