document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderCardView() {
    ...
    permissionGroups.forEach((group) => {
      ...
      <div class="permission-group mb-3" data-group-name="${group.name.toLowerCase()}" data-group-id="${
        group.id
      }">
          <div class="group-header d-flex justify-content-between align-items-center ${
            selectedInGroup > 0 ? "active" : ""
          }">
            <div class="d-flex align-items-center flex-grow-1">
              <div class="permission-icon me-3"><i class="feather-${
                group.icon || "shield"
              }"></i></div>
              <div>
            ...
            <div class="d-flex align-items-center">
              ...
              <i class="ti ti-chevron-right arrow-icon ${
                isGroupInitiallyExpanded ? "rotated" : ""
              }"></i>
            </div>
          </div>
          <div class="group-body ${isGroupInitiallyExpanded ? "show" : ""}">
            ${group.permissions
              ...
              <div class="permission-item ${
                userPermissions.includes(perm.id) ? "selected" : ""
              }" data-id="${
                  perm.id
                ...
                <div class="flex-grow-1">
                  ...
                  <small class="text-muted d-block perm-description-text">${
                    perm.description || ""
                  }</small>
                </div>
                <div class="form-check form-switch ms-3">
                  <input class="form-check-input permission-checkbox" type="checkbox" data-id="${
                    perm.id
    ...
    permissionGroups.forEach((group) => {
      ...
      html += `
        <li>
          <div class="tree-node">
            <a class="tree-toggle ${
              isGroupInitiallyExpanded ? "expanded" : "collapsed"
          ...
          <ul style="display: ${isGroupInitiallyExpanded ? "block" : "none"};">
            ${group.permissions
              .map(
                (perm) => `
              <li>
                <div class="permission-item" data-id="${
                  perm.id
                }" data-perm-name="${perm.name.toLowerCase()}">
                  <div class="flex-grow-1">
