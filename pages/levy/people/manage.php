        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-4">İstanbul 5. İcra</div>
                    <div class="col-md-2 fw-semibold">Dosya No:</div>
                    <div class="col-md-4">2025/1578</div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-2 fw-semibold">İcra Tarihi:</div>
                    <div class="col-md-4">20.02.2020</div>
                    <div class="col-md-2 fw-semibold">İcra Nedeni</div>
                    <div class="col-md-4">Aidat Ödenmemesi</div> <!-- Dinamik olarak hesaplanacak -->
                </div>
                <div class="row mb-2">
                    <div class="col-md-2 fw-semibold">Toplam Borç:</div>
                    <div class="col-md-4">12.500 ₺</div>
                    <div class="col-md-2 fw-semibold">Kalan Borç:</div>
                    <div class="col-md-4">7.500 ₺</div> <!-- Dinamik olarak hesaplanacak -->
                </div>
                <div class="row mb-2">
                    <div class="col-md-2 fw-semibold">Açıklama:</div>
                    <div class="col-md-10">12 Aydır aidat ödenmemesinden dolayı icraya verilmiştir.</div>
