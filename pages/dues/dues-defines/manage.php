    ...
    <div class="page-header-right ms-auto">
        <div class="page-header-right-items">
            ...
            <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                ...
                <button type="button" class="btn btn-outline-secondary route-link me-2" data-page="dues/dues-defines/list">
                    <i class="feather-arrow-left me-2"></i>
                    Listeye Dön
                </button>
                <button type="button" class="btn btn-primary" id="dues_kaydet">
                    ...
                    <div class="row mb-4 align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="amount" id="amount" placeholder="Aidat Tutarı Giriniz"
                                    value="<?php echo $aidatData->amount ?? ''; ?>" required step="0.01">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4 align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control" name="start_date" id="start_date" required
                                    value="<?php echo $aidatData->start_date ?? ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="due_days" id="due_days" placeholder="Ödeme Süresi (Gün)" required
                                    value="<?php echo $aidatData->due_days ?? ''; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4 align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="penalty_rate" id="penalty_rate" placeholder="Ceza Oranı Giriniz"
                                    value="<?php echo $aidatData->penalty_rate ?? ''; ?>" required step="0.01" min="0">
                            </div>
                        </div>
                    </div>              
                </form>
