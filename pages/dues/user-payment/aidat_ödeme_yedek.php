    ...
    <div class="card-body">
            ...
            <table class="table table-hover ">
                ...
                <tbody id="aidatTableBody">
                    ...
                    foreach ($aidatlar as $index => $aidat) {
                        $checked = ""; // Hiçbiri otomatik seçili değil
                    ...
                    ?>
                        <tr data-year="<?= $aidat['yıl'] ?>">
                            ...
                            <td>
                                <input type="checkbox" class="form-check-input aidat-checkbox" <?= $aidat["durum"] == "Ödenmiş" ? "disabled" : "" ?>>
                            </td>
                            <td><?= $statusIcon ?></td>
                        </tr>
                    <?php } ?>
        ...
        <div class="mt-3 text-end">
            <div class="d-flex align-items-center mb-3">
                <input type="checkbox" id="toggleSelection" class="form-check-input me-2">
                <label for="toggleSelection" class="form-check-label">Tümünü Seç / Kaldır</label>
                <button class="btn btn-info mt-3 ms-auto" id="paymentInfoButton" style="float: right;">Ödeme Bilgileri için tıklayınız</button>

            </div>
            <h5 class="mt-3">Toplam Ceza Borcu: <span id="totalPenalty">0₺</span></h5>
...
$(document).ready(function() {
    ...
    $("#toggleSelection").change(function() {
        var isChecked = $(this).is(":checked");
        $(".aidat-checkbox:not(:disabled)").prop("checked", isChecked);
        calculateTotal();
    });

    // Ödeme bilgileri butonuna tıklayınca uyarı göster
    $("#paymentInfoButton").click(function() {
        Swal.fire({
            title: "Ödeme Bilgileri",
            html: `
                <p>Ödeme yapmak için lütfen aşağıdaki bilgileri kullanınız:</p>
                <ul style='text-align: left;'>
                    <li><strong>Banka Adı:</strong> Örnek Bankası</li>
                    <li><strong>Hesap Numarası:</strong> 12345678</li>
