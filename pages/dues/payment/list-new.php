                        ...
                        <div class="d-flex align-items-start justify-content-between">
                            <div>
                                ...
                                <div class="d-flex justify-content-start align-items-center gap-1 mt-2">
                                    ...
                                    <a href="/pages/dues/payment/export/kisi_borc_tahsilat.php?kisi_id=<?= (int)($selectedKisiId ?? 0) ?>&format=html" target="_blank" class="d-flex me-1 printBTN" id="ydPrintHtml">
                                        ...
                                        <a href="/pages/dues/payment/export/kisi_borc_tahsilat.php?kisi_id=<?= (int)($selectedKisiId ?? 0) ?>" class="d-flex me-1 file-download">
                                    ...
                                    <a href="/pages/dues/payment/export/kisi_borc_tahsilat.php?kisi_id=<?= (int)($selectedKisiId ?? 0) ?>&format=xlsx" class="d-flex me-1 file-download">
