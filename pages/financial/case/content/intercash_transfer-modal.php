                ...
                <form action="" id="caseTransferForm">
                    ...
                    <div class="row mb-3 align-items-end">
                        <div class="col">
                            ...
                            <select name="it_to_case" id="it_to_case" class="form-control" data-select2-selector="status">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="it_date" id="it_date" value="<?php echo date("d.m.Y")?>"
