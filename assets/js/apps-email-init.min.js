...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    $("#ccbccToggleModal").click(function (e) {
      e.preventDefault(), $("#ccbccToggleModalFileds").toggle("1000");
    }),
      $("#ccbccToggleContent").click(function (e) {
        e.preventDefault(), $("#ccbccToggleContentFileds").toggle("1000");
      });
  }),
  $(document).ready(function () {
    $('[data-action-target="#mailActionMessage"]').click(function (e) {
      ...
      t.fire({
        ...
        e.value
          ? t.fire("Sent!", "Mail Sent Successfully.", "success")
      ...
      $('[data-action-target="#mailDeleteMessage"]').click(function (e) {
        ...
        t.fire({
          ...
          e.value
            ? t.fire("Deleted!", "Mail Delete Successfully.", "success")
            : e.dismiss === Swal.DismissReason.cancel &&
              t.fire("Cancelled", "Your imaginary file is safe :)", "error");
        });
      });
