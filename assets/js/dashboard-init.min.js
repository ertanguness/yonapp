...
$(function () {
  ...
  $(document).ready(function () {
    if ($("#payment-records-chart").length > 0) {
      ...
      // Kar Marjı: gelir - gider
      var karMarjiData = gelirData.map(function(gelir, i) {
        return gelir - giderData[i];
      });
      ...
      new ApexCharts(document.querySelector("#payment-records-chart"), {
        ...
        colors: ["#25b865", "#23272e", "#d13b4c"], // Yeşil, koyu gri, kırmızı
        ...
        xaxis: {
          ...
          axisBorder: { show: !1 },
          axisTicks: { show: !1 },
          labels: { style: { fontSize: "12px", colors: "#A0ACBB" } }
        },
        yaxis: {
          labels: {
...
$(document).ready(function(){
  if($("#leads-inquiry-tracking").length>0){
