...
$(window).resize(function () {
  ...
  $(function () {
    $("#menu-mini-button").on("click", function () {
      // nxl-item active altındaki submenu gizle
      $(".nxl-item.active .nxl-submenu").css("display", "none");
      ...
      $("#menu-expend-button").on("click", function () {
        $(".nxl-item.active .nxl-submenu").css("display", "block");
        $("#menu-expend-button").hide(),
          $("#menu-mini-button").show(),
          $("html").removeClass("minimenu"),
          localStorage.setItem(
            ...
            0 !== $(t).length && ((e = $(n).offset().top), $(t).offset().top),
              $("body").hasClass(a) && $(n).hasClass(a)
                ? ($("body, .card").removeClass(a),
                  ...
                  $(t).removeAttr("style"))
                : ($("body").addClass(a), $(this).closest(".card").addClass(a)),
  ...
  $(document).ready(function () {
    $(".successAlertMessage").click(function (e) {
      e.preventDefault(),
        ...
        }).fire({ icon: "success", title: "Action Execute Successfully" });
    });
  }),
  $(document).ready(function () {
