...
$(function () {
  ...
  $(function () {
    var a = localStorage.getItem("app-skin")
      ? localStorage.getItem("app-skin")
      : "app-skin-light";
    localStorage.setItem("app-skin", a),
      "app-skin-dark" == localStorage.getItem("app-skin") &&
        $("html").addClass("app-skin-dark") &&
        $(".nxl-head-link.dark-button").addClass("active") &&
        $(".nxl-head-link.light-button").removeClass("active") &&
        $(".nxl-head-link.dark-button").hide() &&
        $(".nxl-head-link.light-button").show(),
      "app-skin-light" == localStorage.getItem("app-skin") &&
        $(".nxl-head-link.dark-button").show() &&
        $(".nxl-head-link.light-button").hide(),
      $(".nxl-head-link.dark-button").on("click", function (a) {
        a.preventDefault(),
          $(".nxl-head-link.dark-button").hide().addClass("active"),
          $(".nxl-head-link.light-button").show().removeClass("active"),
          $("html").addClass("app-skin-dark").removeClass("app-skin-light"),
          localStorage.setItem("app-skin", "app-skin-dark");
      }),
      $(".nxl-head-link.light-button").on("click", function (a) {
        a.preventDefault(),
          $(".nxl-head-link.light-button").hide().addClass("active"),
          $(".nxl-head-link.dark-button").show().removeClass("active"),
          $("html").removeClass("app-skin-dark").addClass("app-skin-light"),
